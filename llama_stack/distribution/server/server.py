...
def main():
    ...
    port = return_flag_value(
        flag="port",
        env_var="LLAMA_STACK_PORT",
        args=args,
        config_file_value=config.server.port,
...
def return_flag_value(
    ...
    user_set_flag = is_flag_set(flag, args)
    if user_set_flag:
